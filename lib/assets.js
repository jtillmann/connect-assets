...
(function() {
  ...
  ConnectAssets = (function() {
    ...
    ConnectAssets.prototype.createHelpers = function() {
      ...
      context.css = function(route, routeOptions) {
        ...
        if (_this.options.pathsOnly || routeOptions.pathsOnly) {
          return route;
        }
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        try {
          ...
          if (ext === 'css') {
            ...
            startTime = new Date;
            css = cssCompilers[ext].compileSync(this.absPath(sourcePath), source, this.options);
  ...
  exports.cssCompilers = cssCompilers = {
    styl: {
      optionsMap: {},
      compileSync: function(sourcePath, source, assetOptions) {
        var callback, options, result, _ref;
        result = '';
        ...
        options = ((_ref = assetOptions.compilerOptions) != null ? _ref.styl : void 0) || {};
        options.filename = sourcePath;
        this.optionsMap[sourcePath] = options;
